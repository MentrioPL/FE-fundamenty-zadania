const inputAResult = document.getElementById("valueA")! as HTMLInputElement
const inputBResult = document.getElementById("valueB")! as HTMLInputElement
const operationInputResult = document.getElementById(
  "operation"
)! as HTMLInputElement
